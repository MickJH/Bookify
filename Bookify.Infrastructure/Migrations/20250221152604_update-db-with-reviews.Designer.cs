...
namespace Bookify.Infrastructure.Migrations
{
    ...
    [Migration("20250221152604_update-db-with-reviews")]
    partial class updatedbwithreviews
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookify.Domain.Appartments.Appartment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bookify.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.HasIndex("AppartmentId")
                        .HasDatabaseName("ix_bookings_appartment_id");
            ...
            modelBuilder.Entity("Bookify.Domain.Reviews.Review", b =>
                {
                    ...
                    b.HasIndex("AppartmentId")
                        .HasDatabaseName("ix_reviews_appartment_id");
            ...
            modelBuilder.Entity("Bookify.Domain.Appartments.Appartment", b =>
                {
                    b.OwnsOne("Bookify.Domain.Shared.Money", "CleaningFee", b1 =>
                        {
                            ...
                            b1.ToTable("appartments");

                            b1.WithOwner()
                                .HasForeignKey("AppartmentId")
                                .HasConstraintName("fk_appartments_appartments_id");
                        });
                    ...
                    b.OwnsOne("Bookify.Domain.Appartments.Records.Address", "Address", b1 =>
                        {
                            b1.Property<Guid>("AppartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookify.Domain.Bookings.Booking", b =>
                {
                    b.HasOne("Bookify.Domain.Appartments.Appartment", null)
                        .WithMany()
                        .HasForeignKey("AppartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_bookings_appartments_appartment_id");
                    ...
                    b.OwnsOne("Bookify.Domain.Bookings.Records.DateRange", "Duration", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookify.Domain.Reviews.Review", b =>
                {
                    b.HasOne("Bookify.Domain.Appartments.Appartment", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_reviews_appartments_appartment_id");
